...
/* Helper for opendir().  */
static unsigned int _tGetFileAttributes (const _TCHAR * tPath)
{
#ifdef _UNICODE
 ...
 */
_TDIR * opendir (const _TCHAR *szPath)
{
  _TDIR *nd;
  unsigned int rc;
 ...
 */
struct _tdirent * readdir (_TDIR * dirp)
{
  errno = 0;
 ...
 * any such system.
 */
void seekdir (_TDIR * dirp, long lPos)
{
  errno = 0;
